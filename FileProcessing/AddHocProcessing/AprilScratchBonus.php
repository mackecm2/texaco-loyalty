...
include "../../include/DB.inc";
	...
	$PromoCode = "AprilScrat";
	$TotalBonus = 0;
	$AccountsBonused = 0;
	$SeriousErrors = 0;
	$sql = "select T.TransactionNo, CardNo from Transactions200504 as T left join BonusHit200504 as B on( T.TransactionNo = B.TransactionNo and PromotionCode = 'AprilScrat' ) where TransValue >= 30 and B.TransactionNo is null";
