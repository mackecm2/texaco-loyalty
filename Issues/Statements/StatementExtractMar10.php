...
$ThisStatementStopTime = "2010-02-29 14:00:00";
...
when A.SegmentCode like 'N%' and StatementPref = 'P' and M.GoneAway ='N'  then 3
when A.SegmentCode like 'N%'  and StatementPref = 'N' and Email not like '%@%'  and M.GoneAway ='N'  then 4 
when (A.SegmentCode like 'A1L%'  or A.SegmentCode like 'A2L%'  )  and StatementPref = 'P'  and M.GoneAway ='N'  then 5
when (A.SegmentCode like 'A1M%'  or A.SegmentCode like 'A2M%'  or A.SegmentCode like 'A1H%'  or A.SegmentCode like 'A2H%'  ) and StatementPref = 'P'  and M.GoneAway ='N'  then 6
when (A.SegmentCode like 'A1M%'  or A.SegmentCode like 'A1H%'  or  A.SegmentCode like 'A2M%'  or A.SegmentCode like 'A2H%'  ) and StatementPref = 'N'  and Email not like '%@%'  and M.GoneAway ='N'  then 7
end as ListCode, 
Balance,
A.SegmentCode,
StatementPref
...
CreateOutputFile( $StatementIdentifier, '/tmp/Mar10StatementData.csv', '1' );
