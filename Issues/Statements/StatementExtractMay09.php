...
$result = DBQueryExitOnFailure( $sql );
//	Update the ListCode table for the StarRewards card holding members.
...
$result2 = DBQueryExitOnFailure( $sql );
//	Now prepare for the StatementPref = N people
