...
$ThisStatementStopTime = "2009-08-04 15:36:18";
...
when (A.SegmentCode like 'A%' or A.SegmentCode like 'N%' or A.SegmentCode like 'L%') and StatementPref = 'P'  and M.GoneAway ='N' then 2 
when (A.SegmentCode like 'A%' or A.SegmentCode like 'N%'  or A.SegmentCode like 'L%' or A.SegmentCode like 'D%') and StatementPref = 'N' and Email like '%@%'  then 1 
when (A.SegmentCode like 'A%' or A.SegmentCode like 'N%' or A.SegmentCode like 'L%') and StatementPref = 'N' and Email not like '%@%'  and M.GoneAway ='N'  then 2
end as ListCode, 
Balance,
A.SegmentCode,
StatementPref
...
CreateOutputFile( $StatementIdentifier, '/tmp/Nov09StatementData.csv', '1' );
