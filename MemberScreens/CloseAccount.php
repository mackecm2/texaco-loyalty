<?php 
	...
	$TrackingOptions = GetTrackingOptionsAccountClose();
...
<CENTER>Are you sure you want to close this account?
	<BR>
	<FORM>
	Reason:
	...
	<BR>
	<BR><BUTTON id="done" onclick="ReturnChoice()" disabled>Close Account</BUTTON>
