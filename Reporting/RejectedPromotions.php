...
<Title>Rejected Promotions Report</Title>
</Head>
<body>
<?php
	connectToDB( MasterServer, TexacoDB );
	$today = date("Y-m-d");  
	$sql = "SELECT StartDate, EndDate, PromotionCode, BonusPoints, PerQuantity, RevisedBy, Comments FROM BonusPoints WHERE Status = 'R' ";
	$res1 = DBQueryExitOnFailure( $sql );
?>
	<h1>Report On Rejected Promotions </h1>
...
if ($count == 1)
{
    echo "No Rejected Promotions found";
}
?>
</body>
</html>