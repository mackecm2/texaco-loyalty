...
#$month = date("F y");
$filename = "FastFuelReport".date("Y_m_d").".csv";
$file2 = "FastFuelMatches".date("Y_m_d").".csv";
$filepath = "/data/www/websites/texaco/FileProcessing/Processed/UKFuels/FastFuel/"	    ;

$month = GetLastMonth();

$timedate = date("Y-m-d")." ".date("H:i:s");
echo "fastfuelreportsender.php - started $timedate\r\n";
	...
	*/
	...
	$mail->AddAddress("richard.hill@ukfuels.co.uk","Richard Hill"); 	// mail recipients
	...
	$mail->Subject  =  "$month FastFuel Fraud Report" ; // set mail subject

	$mail->Body     =   "<p>
			 <font color=\"#004080\" size=\"-1\" face=\"Trebuchet MS, Tahoma, Verdana, Arial\">
			   This is a system generated email from the Texaco Server containing the FastFuel and Star Rewards matching transactions for last month.
			 <br>
...
$timedate = date("Y-m-d")." ".date("H:i:s");
echo "fastfuelreportsender.php - completed $timedate\r\n";
