<?php
	...
	*/
    ...
    $filename			=		"ToEmail.zip"						;
    $filepath 			=		"/data/herersy/"					;
	...
	*/
	...
	$mail->AddReplyTo("mmackechnie@rsm2000.co.uk","Texaco Reply to Address")	; // the reply to mail address and name
	...
	$mail->Subject  =  "New Member Cycle" ; // set mail subject
